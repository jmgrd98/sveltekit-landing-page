...
{#if $openModal}
    <div class="fixed top-0 left-0 w-screen h-screen border-b bg-white z-50 flex flex-col gap-8 p-5 px-8 md:hidden">
        <div class="flex items-center justify-between gap-4 border-b pb-2">
            ...
            <button on:click={() => openModal.set(false)} class="outline-none border-none">
        ...
        <div class="flex flex-col gap-4 flex-1">
            ...
            <button on:click={() => reroute('#review')} class="border-none outline-none p-2 group duration-200 cursor-pointer text-left">
            ...
            <button on:click={() => reroute('#faq')} class="border-none outline-none p-2 group duration-200 cursor-pointer text-left">
